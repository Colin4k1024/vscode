...
export class ChatStatusBarEntry extends Disposable implements IWorkbenchContribution {
	...
	private registerListeners(): void {
		...
		this._register(this.configurationService.onDidChangeConfiguration(e => {
			if ((product.defaultChatAgent !== undefined && e.affectsConfiguration(product.defaultChatAgent.completionsEnablementSetting)) || e.affectsConfiguration(ChatConfiguration.TitleBarSignInEnabled)) {
				this.update();
			}
		}));
	}
